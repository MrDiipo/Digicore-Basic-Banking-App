...
public final class AccountInfoServiceImpl implements AccountInfoService {
    ...
    @Override
    public AccountInfoDto getAccountInfo(String accountNumber, String password) throws AccountNotFoundException, IncorrectPasswordException {
        ...
        accountInfoDto.setResponseCode(ResponseCodes.SUCCESS);
        accountInfoDto.setSuccess(true);
        accountInfoDto.setMessage("");
